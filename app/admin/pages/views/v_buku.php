                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><img src="../../assets/dist/img/upload/<?= $row['image']; ?>" style="height: 50px;width:50px"></img></td>
                                            ...
                                            <div class="modal-content" style="border-radius: 5px;">
                                                ...
                                                <form action="pages/function/Buku.php?act=edit" enctype="multipart/form-data" method="POST">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <img class="form-control" src="../../assets/dist/img/upload/<?= $row['image']; ?>" style="width: 100px; height: 100px"></img>
                                                            <input type="hidden" name="gambarBukuEdit" value="<?= $row['image']; ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Gambar Buku<small style="color: red;">* Wajib diisi</small></label>
                                                            <input type="file" class="form-control upload-preview" placeholder="Masukan Gambar" value="<?= $row['image']; ?>" name="gambarBuku">
                                                        </div>
                                                    </div>
            ...
            <form action="pages/function/Buku.php?act=tambah" enctype="multipart/form-data" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label>Gambar Buku<small style="color: red;">* Wajib diisi</small></label>
                        <input type="file" class="form-control upload-preview" placeholder="Masukan Gambar" name="gambarBuku" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-block">Simpan</button>
